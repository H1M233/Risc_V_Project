...
// Original five-stage pipeline, module name renamed for wrapper.
// All internal connections updated to match current ex/ex_mem/mem/dcache ports.
module top_riscv_inorder(
    input           cpu_rst,
    input           cpu_clk,
    ...
    wire        if_id_valid_o;
    wire [31:0] id_inst_i;
    wire [31:0] id_pred_pc_static;
    assign id_inst_i = if_id_valid_o ? if_id_inst_raw : `NOP;
    assign id_pred_pc_static = id_pc_addr_i + 32'd4;
    ...
    ex EX(
        ...
        .valid_i            (ex_valid_i),
        .mem_forward_rd_addr_i  (mem_rd_addr_o),
        .mem_forward_rd_data_i  (mem_rd_data_o),
        .mem_forward_regs_wen_i (mem_regs_wen_o),
        .mem_forward_opcode_i   (mem_inst_i[6:0]),
        .wb_forward_rd_addr_i   (wb_rd_addr_o),
        .wb_forward_rd_data_i   (wb_rd_data_o),
        .wb_forward_regs_wen_i  (wb_regs_wen_o),
